...
public class PdfConverterBox {
    ...
    public static String addWatermark(Context context, Uri pdfUri, String text, String font, String red, String green, String blue) {
        try {
            String watermarkpath = createWatermarkPdf(text, font, red, green, blue);
...
//            Toast.makeText(context, "PDF Saved at " + path, Toast.LENGTH_SHORT).show();
    ...
    private static String createWatermarkPdf(String text, String fontS, String red, String green, String blue) {
        try {
            PDDocument document = new PDDocument();
            ...
            int fontSize = (int) Float.parseFloat(fontS);
            ...
            stream.setNonStrokingColor(Integer.parseInt(red),Integer.parseInt(green),Integer.parseInt(blue));

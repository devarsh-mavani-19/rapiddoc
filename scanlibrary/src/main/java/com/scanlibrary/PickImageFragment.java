...
public class PickImageFragment extends Fragment {
    ...
    public void onSaveInstanceState(Bundle outState) {
            ...
            if (mFilePath != null)
                outState.putString("imagepath", mFilePath);
            if (fileUri != null) {
                outState.putString("imageuri", fileUri.toString());
            }
    ...
    public void onViewStateRestored(Bundle savedInstanceState) {
        if(savedInstanceState!=null) {
            if (savedInstanceState.containsKey("imagepath")) {
                mFilePath = savedInstanceState.getString("imagepath");
            }
            if (savedInstanceState.containsKey("imageuri")) {
                fileUri = Uri.parse(savedInstanceState.getString("imageuri"));
            }
        }
    ...
    private File createImageFile() {
        ...
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new
                Date());
        String filePath = ScanConstants.IMAGE_PATH + "/IMG_" + timeStamp +
                ".jpg";
